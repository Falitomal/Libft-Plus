...
** then the function returns the length of the source string plus the size of the destination buffer.
** This ensures that the resulting string will not be truncated
*/
